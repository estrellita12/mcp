...
var item_info = {
    ...
    "furniture" : {
        ...
        "article" : {
            "product_name" : ["품명", ""],
            "certification" : ["KC 인증 필 유무", "[품질경영 및 공산품안전관리법 상 안전&middot;품질표시대상공산품에 한함]"],
            "color" : ["색상", ""],
            "component" : ["구성품", ""],
            "material" : ["주요소재", ""],
    ...
    "medical":{
        ...
        "article":{
            "product_name":["품명", ""],
            "model_name":["모델명", ""],
            "license_number":["의료기기법상 허가&middot;신고 번호", "허가&middot;신고 대상 의료기기에 한함"],
    ...
    "kitchenware":{
        ...
        "article":{
            ...
            "maker":["제조자", "수입품의 경우 수입자를 함께 표기 [병행수입의 경우 병행수입 여부로 대체 가능]"],
            "madein":["제조국", ""],
            "import_declaration":["식품위생법에 따른 수입 신고", "식품위생법에 따른 수입 기구&middot;용기의 경우 \"식품위생법에 따른 수입신고를 필함\"의 문구"],
            "warranty":["품질보증기준", ""],
            "as":["A/S 책임자와 전화번호", ""],
        }
    },
    ...
    "rent_car":{
        ...
        "article":{
            ...
            "vehicle_breakdown":["차량의 고장&middot훼손 시 소비자 책임", ""],
    ...
    "rental_water":{
        ...
        "article":{
            ...
            "maintenance":["유지보수 조건", "점검&middot;필터교환 주기, 추가 비용 등"],
            "consumer_responsibility":["상품의 고장&middot;분실&middot;훼손 시 소비자 책임", ""],
    ...
    "digital_contents":{
        ...
        "article":{
            ...
            "transfer_of_ownership":["소유권 이전 조건", "소유권이 이전되는 경우에 한함"],
            "maintenance":["청약철회 또는 계약의 해제&middot;해지에 따른 효과", ""],
            "as":["소비자상담 관련 전화번호", ""],
        }
    },
    "gift_card":{
    ...
    "etc":{
        ...
        "article":{
            "product_name":["품명", ""],
            "model_name":["모델명", ""],
            "certified_by_law":["법에 의한 인증&middot허가 등을 받았음을 확인할 수 있는 경우 그에 대한 사항", ""],
            "origin":["제조국 또는 원산지", ""],
            "maker":["제조자", "수입품의 경우 수입자를 함께 표기 [병행수입의 경우 병행수입 여부로 대체 가능]"],
