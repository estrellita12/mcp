            ...
            <div class="list_wrap">
                <div class="rect_wrap">
                    ...
                    <span class="right_wrap">
                        <a href="/Seller/listExcel?<?=get_qstr("rpp,page")?>" class="btn_excel"> 엑셀저장</a>
                    </span>
                </div>
                <div class="btn_wrap">
                    <a href="/Seller/form" class="btn_small btn_white">+ 공급사 추가</a>
                </div>
                <div class="chead01_wrap" id="reload_wrap">
                    <table>
                        ...
                        <tr class="list<?=$i%2?>">
                            ...
                            <td><?=$row['sl_name']?></td>
                            <td><?=sl_id($row['sl_id'])?><?=id_log($row['sl_id'],"web_seller")?></td>
                            <td><?=$this->gr_li[$row['sl_grade']]?></td>
                            <td><?=$row['sl_pay_rate']?>%</td>
                            <td><?=$row['sl_reg_dt']?></td>
                            <td><?=$row['sl_app_dt']?></td>
