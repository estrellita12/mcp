    ...
    <div class="cont_wrap">
        ...
        <form>
            <div class="list_wrap">
                ...
                <div class="btn_wrap">
                    <a href="#" id="approval" class="list_update btn_small btn_line_blue" data-tab="Seller">선택 승인</a>
                </div>
                <div class="chead01_wrap" id="reload_wrap">
                    <table>
                        ...
                        <tr class="list<?=$i%2?>">
                            ...
                            <td><a href="/Seller/approval/<?=$row['sl_id']?>" class="btn_white btn_small">승인</a></td>
                        </tr>
                        <?php  $i++; } ?>
                        </tbody>
                    </table>
