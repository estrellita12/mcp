<section class="contents">
    ...
    <div class="cont_wrap">
        <form name="fsellerForm" action="/Seller/add" method="POST" onsubmit="return frmRegsubmit(this)" enctype="MULTIPART/FORM-DATA">
            ...
            <div class="confirm_wrap">
                ...
                <a href="/Seller/list" class="btn_large btn_white">목록</a>
            </div>
        </form>
    </div>
</section>
