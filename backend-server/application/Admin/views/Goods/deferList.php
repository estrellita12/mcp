    ...
    <div class="cont_wrap">
        ...
        <form>
            <div class="list_wrap">
                ...
                <div class="btn_wrap">
                    <a href="#" id="approval" class="list_update btn_small btn_line_blue" data-tab="Goods">상품 승인</a>
                    <a href="#" id="remove" class="list_update btn_small btn_line_red" data-tab="Goods">상품 삭제 요청</a>
                </div>
                <div class="chead01_wrap" id="reload_wrap">
                    <table>
                        ...
                        <tr class="list<?= $i%2 ?>">
                            ...
                            <td class="tal dot"><?=gs_name($row['gs_id'],$row['gs_name'])?><?=id_history($row['gs_id'],"Goods")?></td>
