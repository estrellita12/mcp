<tr>
    ...
    <td>
        <select name="srch" id="srch" class="w130">
            <?= get_frm_option('id', get_request("srch"), '상품번호(ID)'); ?>
            <?= get_frm_option('code', get_request("srch"), '상품코드'); ?>
            <?= get_frm_option('name', get_request("srch"), '상품명'); ?>
        </select>
...
<tr>
    ...
    <td>
        ...
        <?=$this->category->printDepthList(3, get_request("ctg"), 'ctg3'); ?>
        <?=$this->category->printDepthList(4, get_request("ctg"), 'ctg4'); ?>
        <?=$this->category->printDepthList(5, get_request("ctg"), 'ctg5'); ?>
<script>
$(function() {
    ...
    <td>
        <div>
            <select name="term" class="w130">
                <?= get_frm_option('regDate', get_request("term"), '상품등록일'); ?>
                <?= get_frm_option('updateDate', get_request("term"), '상품수정일'); ?>
            </select>
