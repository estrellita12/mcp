            ...
            <div class="list_wrap">
                ...
                <div class="chead01_wrap" id="reload_wrap">
                    <table>
                        ...
                        <tbody>
                        <?php $i=0; foreach($this->review->getList($this->col) as $row) { ?>
                        <tr class="list<?= $i%2 ?>">
                            <td><?=$row['gs_rv_id']?></td>
                            ...
                            <td><?=sl_id($row['gs_rv_sl_id'], $this->sl_li[$row['gs_rv_sl_id']])?></td>
                            <td><?=pt_id($row['gs_rv_pt_id'], $this->pt_li[$row['gs_rv_pt_id']])?></td>
