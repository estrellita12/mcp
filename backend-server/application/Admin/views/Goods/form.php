            ...
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="code" value="<?=get_gs_code()?>">
                            <p class="info">상품 코드는 임의 설정이 가능하지만, 코드가 중복된 경우 등록이 실패됩니다.</p>
                        </td>
                    </tr>   
                    <tr>
                        <th scope="row">상품명</th>
                        <td><input type="text" name="name" class="w100p required" required></td>
                    </tr>   
                    <tr>
                        <th scope="row">짧은 설명</th>
                        <td>
                            <p class="info">상품 약어, 간략한 상품명으로써 택배송장 출력과 물류 담당자의 빠른 인식을 위하여 사용할 수 있습니다.</p>
                            <input type="text" name="explan" class="w100p">
                        </td>
                    </tr>   
                    <tr>
                        <th scope="row">키워드</th>
                        <td>
                            ...
                            <input type="text" name="keywords" class="w100p">
                        </td>
                    </tr>   
                    <tr>
            ...
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="chead02_wrap">
                            옵션 제목 : <input type="text" name="addOptSubject" placeholder="선물 포장">
                            <p class="info"></p>
                            <table>
                                <colgroup>
                                    <col class="w100">
            ...
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        <th scope="row">수수료</th>
                        <td>
                            <input type="text" name="payRate" id="payRate" value="10" class="tar comma w200" required> <span class="marr10">%</span>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">공급가</th>
                        <td>
                            <input type="text" name="supplyPrice" id="supplyPrice" value="0" class="tar comma w200" required readonly> 원
                    ...
                    <tr>
                        ...
                        <td>
                            <?=get_frm_radio("goodsPriceAuto","1","1", " 자동반영")?>
                            <?=get_frm_radio("goodsPriceAuto","2","1", " 수동반영")?>
                        </td>
                    </tr>
                    <?php foreach($this->pt_gr_li as $idx=>$grade){ ?>
                    <tr class="detail_price">
                        <th scope="row"><?=$grade?></th>
                        <td><input type="text" name="goodsPrice<?=$idx?>" class="tar comma" size="15"> 원</td>
                    </tr>
                    <?php } ?>
                    -->
                    <tr>
            ...
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td><?=get_frm_radio('deliveryType',$key,"1", $value[0],"required" );?></td>
                                    <td><?=$value[1]?></td>
                                </tr>
                                <?php } ?>
                            </table>
                    ...
                    <tr class="delivery_charge dn">
                        ...
                        <td>
                            <input type="text" name="deliveryCharge" value="<?=number_format(3000)?>" class="tar comma w100"> 원
                        </td>
                    </tr>
                    <tr class="delivery_free dn">
                        <th scope="row">조건부 무료<br>주문 금액</th>
                        <td>
                            <input type="text" name="deliveryFree" value="<?=number_format(20000)?>" class="tar comma w100"> 원
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">교환/반품 배송비</th>
                        <td>
                            <input type="text" name="claimDeliveryCharge" value="<?=number_format(6000)?>" class="tar comma w100"> 원
                        </td>
                    </tr>
                    <tr>
