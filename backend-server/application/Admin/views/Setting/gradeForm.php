<div id="contents">
    ...
    <section class="cont_inner">
        ...
        <form action="/Setting/gradeFormUpdate" method="POST">
            <div class="chead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        <td class="tac">
                            <input type="hidden" name="id[<?=$i?>]" value="<?=$row['adm_grade']?>">
                            <?=$row['adm_grade']?>
                        </td>
                        <td><input type="text" name="name[<?=$i?>]" value="<?=$row['adm_grade_name']?>" size=8></td>
                        <td>
                            <input type="text" name="sale[<?=$i?>]" value="<?=$row['adm_grade_sale']?>" size=3>
                            <select name="sunit[<?=$i?>]">
                        ...
                        <td><input type="text" name="memo[<?=$i?>]"  value="<?=$row['adm_grade_adm_memo']?>" size=40></td>
                    </tr>
                    <?php $i++; } ?>
                    </tbody>
                </table>
