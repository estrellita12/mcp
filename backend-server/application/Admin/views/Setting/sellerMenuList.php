<section class="contents">
    ...
    <div class="cont_wrap">
        ...
        <script>
$(function() {
        $("#menu1").ctg_select_box("#menu",5,"/Setting/getNextSellerMenu","==메뉴 선택==");
        $("#menu2").ctg_select_box("#menu",5,"/Setting/getNextSellerMenu","==메뉴 선택==");
        $("#menu3").ctg_select_box("#menu",5,"/Setting/getNextSellerMenu","==메뉴 선택==");
        });
        </script>
        <br>
...
function changeData(code){
    $("#fForm").attr("action","/Setting/setSellerMenu/"+code);
    $.ajax({
type: "POST",
url: '/Setting/printSellerMenu/'+code,
data: { "code":code },
dataType: 'json',
...
function addMenu(sel_id,depth){
    ...
    location.href='/Setting/addSellerMenu/'+upper;
}

function removeMenu(sel_id){
    var code = $('#'+sel_id).val();
    location.href='/Setting/removeSellerMenu/'+code;
}
...
function moveMenu(sel_id, pos){
    ...
    var str = arr.join(",");
    location.href='/Setting/sortableSellerMenu?orderby='+str;
}
