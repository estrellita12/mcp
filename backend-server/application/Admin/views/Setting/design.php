<section class="cont_inner">
    ...
    <form action="/Setting/setDefault" method="POST" enctype="MULTIPART/FORM-DATA">
        <div class="rhead01_wrap">
            <div class="h2">쇼핑몰 설정</div>
            <table>
                <colgroup>
                    <col class="w150">
                    <col>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><textarea name="headTag"><?=stripslashes($this->row['shop_head_tag'])?></textarea></td>
                    </tr>
                    <tr>
                        <th scope="col">BODY 스크립트 태그</th>
                        <td><textarea name="bodyTag"><?=stripslashes($this->row['shop_body_tag'])?></textarea></td>
                    </tr>
                </tbody>
            </table>
        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="img_wrap"> <?=get_img( _LOGO.$this->row['shop_favicon'] )?> </div>
