            ...
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <th scope="row">가맹점</th>
                        <td>
                            <select name="shop" class="required w130" required>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/Member/savePoint/<?=$this->param['ident']?>?point=1000" class="btn_small btn_blue">포인트 추가</a>
                            <a href="/Member/usePoint/<?=$this->param['ident']?>?point=1000" class="btn_small btn_red">포인트 차감</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea name="memo" class="frm_textbox" rows="3"><?= $this->row['mb_adm_memo'] ?></textarea>
                            <p class="info">해당 내용은 회원에게는 표시되지 않으며, 가맹점에는 표시됩니다.</p>
                        </td>
                    </tr>
                    </tbody>
                </table>
