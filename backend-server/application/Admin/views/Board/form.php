                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="skin">
                                ...
                                <?=get_frm_option($value,null,$value); ?>
                                <?php } ?>
                            </select>                            
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="marl10"><input type="checkbox" name="use_reply" value="y"> 사용</label>
                        </td>
                    </tr>                          
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="marl10"><input type="checkbox" name="use_comment" value="y"> 사용</label>
                        </td>
                    </tr>                          
                    <tr>
