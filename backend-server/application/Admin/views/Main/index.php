...
<section class="contents" id="main_index">
   ...
   <div class="marb40">
        <div class="h2">상품 관리</div>
        <div class="index_wrap">
            <div class="box_wrap box_col4">
                <div class="item_wrap box_col3">
                    <div class="item_title">대기 상품</div>
                    <div class="item_data"><span class="number_data"><?=number_format($this->goods['wait_cnt'])?></span>개</div>
                </div>
                <div class="item_wrap box_col3">
                    <div class="item_title">보류 상품</div>
                    <div class="item_data"><span class="number_data"><?=number_format($this->goods['defer_cnt'])?></span>개</div>
                </div>
            </div>
            <div class="box_wrap box_col2 marl30">
                <div class="item_wrap box_col6">
