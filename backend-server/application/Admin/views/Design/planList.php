        ...
        <form>
            <div class="list_wrap">
                ...
                <div class="btn_wrap">
                    ...
                    <a href="#" onclick="winOpen('/Design/planOdrPopup','planSortable','1200','800','yes');" class="btn_small btn_red">순서 변경</a>
                ...
                <div class="chead01_wrap" id="reload_wrap">
                    <table>
                        ...
                        <tbody>
                        <?php $i=0; foreach( $this->plan->getList($this->col) as $row) {?>
                        <tr>
                            ...
                            <td><?=img_visible($row['plan_show_yn'],'y')?></td>
