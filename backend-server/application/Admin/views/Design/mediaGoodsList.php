<section class="cont_inner">
    <h1 class="pg_tit"><?=empty($this->tabInfo['name'])?"기획전 상품 설정":$this->tabInfo['name'];?></h1>
    <div class="pg_info">
        <ul>
    ...
    <form action="/Design/setMediaGoods/<?=$this->param['ident']?>" method="POST" onsubmit="return frmExample()">
