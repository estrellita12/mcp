<section class="contents">
    <h1 class="cont_title">배너 순서 변경 > <?= $GLOBALS['banner'][$_REQUEST['device']][$_REQUEST['position']]?></h1>
    <div class="cont_wrap">
        <form name="fbannerForm" action="/Design/sortableBanner" method="POST">
            ...
            <div class="list_wrap">
                <div class="chead02_wrap">
                    ...
                    <p class="pg_info"> 배너를 드래그하여 순서를 변경해주세요. 변경 후 변경 사항 적용 버튼을 클릭해야 반영됩니다.<br>특정 가맹점 배너는 전체 가맹점 배너 보다 무조건 앞서 노출됩니다.</p>
                    <div class="rect_wrap">
                    ...
                    <table>
                        ...
                        <tr class="list<?=$i%2?>" data-idx="<?=$row['bn_id']?>">
                            ...
                            <td class="w150 tal"><?=$this->category->getNavStr($row['ctg_id'])?></td>
