            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php foreach( $GLOBALS['od_stt'] as $key=>$value ){ if($key <= 30 || $key >= 40) continue;?>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="deliveryCompany4[]" <?=$_REQUEST['state']!=32?"disabled":""?>>
                                        <?=get_frm_option("",$row['od_delivery_company4'],"선택")?>
                                        <?php foreach($this->config['cf_delivery_company'] as $key=>$dv){ ?>
                                        <?=get_frm_option($key,$row['od_delivery_company4'],$dv['company'])?>
                                        <?php } ?>
                                    </select>
                                </td>
                                <td><input type="text" name="deliveryNo4[]" value="<?=$row['od_delivery_no4']?>" class="w100p" <?=$_REQUEST['state']!=32?"disabled":""?>></td>
