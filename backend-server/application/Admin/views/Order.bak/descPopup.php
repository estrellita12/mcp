<section class="cont_inner">
    <h1 class="pg_tit">주문 상세 정보<span class="pg_info">주문상세정보 페이지 입니다. 회색 박스를 더블 클릭하면 데이터를 변경할수있습니다.</span></h1>
            ...
            <table>
                ...
                <tbody> 
                    ...
                    <tr>
                        ...
                        <th>옵션명</th>
                        <td colspan="3"><?=$this->row['od_goods_info']['optionName']?></td>
                    </tr>
                    <tr>
                        <th>상품 가격</th>
                        <td><?=number_format($this->row['od_goods_price']/$this->row['od_qty'])?> 개</td>
                        <th>주문 수량</th>
