                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="info">
                                <label><input type="checkbox" name="use_reply" value="Y" <?=get_checked('Y',$this->row['bo_use_reply'])?>> 사용</label>
                            </span>                            
                        </td>
                    </tr>                          
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="info">
                                <label><input type="checkbox" name="use_comment" value="Y" <?=get_checked('Y',$this->row['bo_use_comment'])?>> 사용</label>
                            </span>                            
                        </td>
                    </tr>                          
                    <tr>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="img_wrap"> <?=get_img( _BOARD.$this->row['bo_t_img'] , 160)?> </div>                            
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="img_wrap"> <?=get_img( _BOARD.$this->row['bo_d_img'] , 160)?> </div>                            
                            <span class="info">권장 사이즈 (000px * 000px)</span>
                        </td>
                    </tr>
                    <tr>
