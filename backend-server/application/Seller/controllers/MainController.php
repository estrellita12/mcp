...
class MainController extends Controller{
    ...
    public function index(){
        ...
        $this->board = $boardModel->get("bo_id,bo_name",array("bogr_id"=>"seller_service_center"));
        if( !empty($this->board) ){
        ...
        $search = array();
        $search['gs_qa_sl_id'] = $_SESSION['user_id'];
    ...
    public function notice(){
        ...
        $boardModel = new \application\models\BoardModel();
        $rowAll = $boardModel->get("bo_id,bo_name",array("bogr_id"=>"seller_service_center"),true);
        $this->bo_li = array();
    ...
    public function postView(){
        ...
        $boardModel = new \application\models\BoardModel();
        $this->boardRow = $boardModel->get("*",array("bo_id"=>$_REQUEST['board']));
        if($this->boardRow['bo_read_perm']!="seller") access($msg,"/Main/notice");
        $this->replyAllow = false;
        if( $this->boardRow['bo_use_reply'] == "y" ){
            if( $this->boardRow['bo_reply_perm']=="seller" || $this->boardRow['bo_reply_perm']=="guest" ){
                $this->replyAllow = true;
        ...
        $this->postModel = new \application\models\PostModel($_REQUEST['board']);
        $this->postModel->view($this->param['ident']);
    ...
    public function postAnswer(){
        ...
        $boardModel = new \application\models\BoardModel();
        $this->boardRow = $boardModel->get("*",array("bo_id"=>$_REQUEST['board']));
        if($this->boardRow['bo_reply_perm']!="seller") access($msg,"/Main/notice");
    ...
    public function addAnswer(){
        ...
        if($boardRow['bo_reply_perm']!="seller") access($msg,"/Main/notice");
...
*/
    ...
    public function addComment(){
        ...
        if($boardRow['bo_comment_perm']!="seller") access($msg,"/Main/notice");
