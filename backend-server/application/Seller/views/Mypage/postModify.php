<section class="contents">
    ...
    <div class="cont_wrap">
        <form name="fboardForm" enctype="MULTIPART/FORM-DATA" action="/Mypage/setPost/<?=$this->row['bopo_id']?>" method="POST">
            ...
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        <th scope="row">제목</th>
                        <td><input type="text" name="title" class="required" size=50 value="<?=$this->row['bopo_title']?>" required></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="secretYn" value="y" <?=$this->row['bopo_secret_yn']=="y"?"checked":""?>> 비밀글</label>
                            <?php } ?>
                    ...
                    <tr>
                        <th scope="row">내용</th>
                        <td>
                            <?= editor_html('content',get_text($this->row['bopo_content'],0)) ?>
                        </td>
                    </tr>
                </table>
            </div>
