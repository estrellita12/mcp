...
$excel->mergeCells('A1:L1')->setCellValue('A1', $this->my['sl_name']." 정산 상세 내역");
...
foreach($this->cancelList as $row) {
    ...
    $char = 'A';
    $excel->setCellValue($char++.$i,$this->my['sl_name'])
...
$filename = $this->my['sl_name'].'_정산_상세_내역_'.date("Ymd", _SERVER_TIME) ;
