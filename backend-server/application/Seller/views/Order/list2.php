<section class="contents">
    ...
    <div class="cont_wrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="checkbox" name="chk[]" value="<?=$i?>" <?=$row['pt_id']=="alldeal"?"disabled":""?>>
                                </td>
                                <?php if($j==0){  ?>
        ...
        <div class="help_wrap">
            ...
            <div class="h3">체크박스 선택이 안되는 주문건을 어떤 경우 인가요?</div>
            <ul>
                <li>일부 가맹점의 경우, 결제 완료에서 상품 준비 중으로 자동으로 상태가 변경됩니다.</li>
                <li>임의의 상태를 변경하는 경우, 에러가 발생 할 수 있으니 주의해 주시기 바랍니다.</li>
            </ul>
