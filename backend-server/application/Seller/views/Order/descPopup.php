        ...
        <form name="forderForm" action="/Order/setState/<?=$this->row['od_id']?>" method="POST" onsubmit=" return forderSubmit()">
            ...
            <div class="rhead01_wrap">
                ...
                <div class="btn_wrap tar">
                    <input type="hidden" name="type" value="상태변경">
                    <input type="submit" class="btn_small btn_red" value="주문 상태 변경">
                </div>
            </div>
        </form>
                ...
                <table>
                    ...
                    <tbody> 
                        <tr>
                            ...
                            <th>상품명</th>
                            <td colspan="3"><?=$this->row['od_goods_info']['goodsName']?></td>
                        </tr>
                        <tr>
                            <th>옵션번호(ID)</th>
                        ...
                        <tr>
                            ...
                            <th>총 공급가액</th>
                            <td class="fw_500" colspan="3"><?=number_format($this->row['od_supply_price'])?> 원</td>
                        </tr>
                        <tr>
                            ...
                            <td class="fw_500 bg_light_blue" colspan="3">
                                <input type="text" name="deliveryChargeDosan" class="comma" value="<?=number_format($this->row['od_delivery_charge_dosan'])?>" size=5 readonly> 원
                            </td>
                        </tr>
                        <tr>
                            <th>결제 일시</th>
                ...
                <table>
                    ...
                    <tbody> 
                        ...
                        <tr>
                            ...
                            <td colspan="3"><?=$this->row['od_adm_memo']?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
