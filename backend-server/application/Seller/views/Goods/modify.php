                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="fixed-clear">
                                <div class="w20p fl"><?=$this->categoryModel->printDepthList(1, "", 'ctg1', ' class="multiple-select" multiple' ); ?></div>
                                <div class="w20p fl"><?=$this->categoryModel->printDepthList(2, "", 'ctg2', ' class="multiple-select" multiple' ); ?></div>
                                <div class="w20p fl"><?=$this->categoryModel->printDepthList(3, "", 'ctg3', ' class="multiple-select" multiple' ); ?></div>
                                <div class="w20p fl"><?=$this->categoryModel->printDepthList(4, "", 'ctg4', ' class="multiple-select" multiple' ); ?></div>
                                <div class="w20p fl"><?=$this->categoryModel->printDepthList(5, "", 'ctg5', ' class="multiple-select" multiple' ); ?></div>
                            </div>
        ...
        $("#ctg5").ctg_select_box("#ctg",5,"","=카테고리선택=");
                        ...
                        <td>
                            <div>
                                ...
                                <select name="selectCtg" id="selectCtg" size="5" class="multiple-select" multiple >
                                    <?php if($ctg=$this->categoryModel->getNavStr($this->row['gs_ctg'])){ ?>
                                    <option value="<?=$this->row['gs_ctg']?>"><?=$ctg?></option>
                                    <?php } ?>
                                    <?php if($ctg=$this->categoryModel->getNavStr($this->row['gs_ctg2'])){ ?>
                                    <option value="<?=$this->row['gs_ctg2']?>"><?=$ctg?></option>
                                    <?php } ?>
                                    <?php if($ctg=$this->categoryModel->getNavStr($this->row['gs_ctg3'])){ ?>
            ...
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        <th scope="row">공급사</th>
                        <td><?=$this->my['sl_name']?> (<?=$this->my['sl_id']?>)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="chead02_wrap">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td><input type="hidden" name="opt[id][]" value="<?=$opt['gs_opt_id']?>"><?=$opt['gs_opt_id']?></td>
                                    <td>
                                        <input type="text" name="opt[code][]" value="<?=$opt['gs_opt_code']?>" class="tar">
                                    ...
                                    <td>
                                        <input type="text" name="opt[name][]" value="<?=$opt['gs_opt_name']?>" class="w100p opt_name"  onkeyup="stockCnt()" required>
                                    </td>
                                    <td><input type="text" name="opt[supplyPrice][]" value="<?=number_format($opt['gs_opt_supply_price'])?>" class="tar comma supply_price w100p" readonly></td>
                                    <td><input type="text" name="opt[addPrice][]" value="<?=number_format($opt['gs_opt_add_price'])?>" class="tar comma add_price w100p" onkeyup='getSupplyPrice()'></td>
                                    <td><input type="text" name="opt[stockQty][]" value="<?=number_format($opt['gs_opt_stock_qty'])?>" class="tar comma stock_qty w100p" maxlength=3 onkeyup="stockCnt()"></td>
                                    <td>
                                ...
                                <table>
                                    ...
                                    <tbody id="aopt">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="aopt[qtyNoti][]" value="<?=$opt['gs_opt_stock_qty_noti']?>" class="tar" size=3></td>
                                            <td>
            ...
            <div class="rhead01_wrap">
                <div class="h2">가격 및 구매 옵션</div>
                <p class="info">가격(소비자가(TAG가),판매가,공급가)을 변경하시는 경우, 상품은 대기 상태가 됩니다.</p>
                <table>
                    <colgroup>
                        <col class="w150">
                        <col>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="qtyNoti" value="<?=$this->row['gs_stock_qty_noti']?>" class="tar comma w100"> 개
            ...
            <div class="confirm_wrap">
                ...
                <a href="/Goods/remove/<?=$this->row['bo_id']?>?preUrl=<?=urlencode($_GET['returnUrl'])?>" class="btn_large btn_red" onclick="return confirm('해당 상품을 삭제하시겠습니다?\n삭제 처리된  데이터는 복구 불가능합니다.')">삭제</a>
            </div>
        </form>
    </div>
</section>
