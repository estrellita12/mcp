<section class="cont_inner">
    ...
    <form name="fcategoryForm" action="/Goods/setCategoryExcel" method="POST" enctype="multipart/form-data">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="/Goods/categoryBulkEditExcel" class="btn btn_small btn_blue">데이터 다운로드</a></td>
                    </tr>
                    <tr>
