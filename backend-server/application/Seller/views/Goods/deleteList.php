        ...
        <div class="layout01_wrap">
            <div class="layout_inner">
                ...
                <div class="btn_wrap">
                    ...
                    <a href="#" id="remove" class="list_update btn_small btn_line_red" data-tab="Goods">상품 삭제</a>
                </div>
                <div class="chead01_wrap">
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php foreach($this->pt_gr_li as $idx=>$grade){ ?>
                                <td><?=number_format($row["gs_price_{$idx}"])?>원</td>
                            <?php } ?>
