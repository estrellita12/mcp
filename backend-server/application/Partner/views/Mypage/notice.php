                    ...
                    <tr>
                        ...
                        <td>
                            <select name="srch" id="srch" class="w130">
                                <?= get_frm_option('bopo_title', $_REQUEST['srch'], '제목'); ?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="term" class="w130">
                                <?= get_frm_option('bopo_reg_dt', $_REQUEST['term'], '등록일'); ?>
                            </select>
                ...
                <div class="chead01_wrap">
                    <table class="draggable">
                       <thead>
                        ...
                        <tbody>
                            <?php $i=0; foreach( $this->post->getList($this->col) as $row) {?>
                            <tr class="list<?=$i%2?>">
                            ...
                            <?php foreach( $this->post->get($this->col,array("bopo_pid"=>$row['bopo_id'],"col"=>"bopo_reg_dt","colby"=>"asc"),true) as $row2) { ?>
                            <tr class="list0">
                                <td></td>
                                <td></td>
                                <td class="tal">
