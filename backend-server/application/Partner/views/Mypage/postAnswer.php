    ...
    <div class="cont_wrap">
        <form name="fboardForm" enctype="MULTIPART/FORM-DATA" action="/Mypage/addPost" method="POST">
            ...
            <div class="confirm_wrap">
                <input type="submit" value="등록" id="btn_submit" class="btn_theme btn_large" accesskey="s">
                <a href="<?=empty($_REQUEST['returnUrl'])?"/Board/postList":urldecode($_REQUEST['returnUrl'])?>" class="btn_large btn_white" accesskey="s">목록</a>
            </div>
        </form>
    </div>
</section>
