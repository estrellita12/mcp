    ...
    <div class="cont_wrap">
        ...
        <form>
            <div class="list_wrap">
                ...
                <div class="btn_wrap">
                    <?php if( $this->board['bo_write_perm'] == "partner" || $this->board['bo_write_perm'] == "guest" ){ ?>
                ...
                <div class="chead01_wrap" id="reload_wrap">
                    <table>
                        ...
                        <tbody>
                        <?php $i=0; foreach( $this->postModel->get($this->col,$this->search,true,$this->sql) as $row) { ?>
                        <tr class="list<?=$i%2?>">
                            <td><?=$row['bopo_id']?></td>
                            <td class="tal">
                        ...
                        <?php foreach( $this->postModel->getDepthList($row['bopo_id']) as $row2) { ?>
                        <tr class="list0">
                            <td>-</td>
                            <td class="tal">
