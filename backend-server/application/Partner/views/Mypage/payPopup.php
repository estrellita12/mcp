                ...
                <form name="fsellerPayForm" action="/Seller/calculate" method="POST">
                    <div class="rhead01_wrap">
                        ...
                        <table>
                            ...
                            <tr>
                                <th scope="row">은행</th>
                                <td><input type="hidden" name="bank" value="<?=$this->sl['sl_bank_info'][0]?>"><?=$this->sl['sl_bank_info'][0]?></td>
                            </tr>
                            <tr>
                                <th scope="row">계좌번호</th>
                                <td><input type="hidden" name="account" value="<?=$this->sl['sl_bank_info'][1]?>"><?=$this->sl['sl_bank_info'][1]?></td>
                            </tr>
                            <tr>
                                <th scope="row">예금주</th>
                                <td><input type="hidden" name="holder" value="<?=$this->sl['sl_bank_info'][2]?>"><?=$this->sl['sl_bank_info'][2]?></td>
                            </tr>
                            <tr>
