...
$(function() {
        ...
        <form action="/Mypage/setGoodsList" method="post" id="selectedGoods">
            <div class="list_wrap">
                <table>
                    <colgroup>
                        <col class="w50p">
                    ...
                    <tbody>
                    <tr>
                        <td class="tal rect_wrap padl10">
                            <span class="cnt_wrap">
                                검색된 총 상품수 : <span class="cnt"><?= number_format( $this->cnt ) ?></span> 개
                            </span>
                            <span class="rpp_wrap">
                            ...
                            <span class="right_wrap padr10">
                                <button type="button"  class="btn_small btn_blue" onClick="add_goods()">추가</button>
                            </span>
                        </td> 
                        <td class="tal rect_wrap padl10">
                            <span class="cnt_wrap">
                                선택된 총 상품수 : <span class="cnt" id="selectedCnt"><?=$this->selectedCnt?></span> 개
                            </span>
                            ...
                            <div class="chead02_wrap">
                                ...
                                <table>
                                    ...
                                    <tr data-idx="<?=$row['gs_id']?>">
                                        ...
                                        <td><?=$GLOBALS['gs_isopen'][$row['gs_isopen']]?></td>
                                        <td><?=number_format($row['gs_stock_qty'])?></td>
                                        <td><button type="button" class="btn_ssmall btn_red" onclick="delete_goods('<?=$row['gs_id']?>')">삭제</button></td>
                                    </tr>
                                    <?php  $i++; } ?>
                                    </tbody>
                                </table>
