<section class="contents">
    ...
    <div class="cont_wrap">
        <form name="fForm" action="/Design/addPlan" method="POST" enctype="MULTIPART/FORM-DATA">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select id="ctg1" name="ctg1" required>
                                ...
                                <?=get_frm_option($row['ctg_id'], "", $row['ctg_title']);?>
                                <?php } ?>
                            </select>

                            <?=$this->categoryModel->printDepthList(2, '', 'ctg2', 'required'); ?>
                            <script>
$(function() {
                            ...
                            <div class="list_wrap">
                                <div class="rect_wrap">
                                    ...
                                    <span class="right_wrap">
                                        ...
                                        <a href="#" onclick="winOpen('/Design/goodsListPopup/<?=$_REQUEST['goodsId']?>','planGoodsList','1200','700','yes');" class="btn_small btn_blue">관련 상품 코드 변경</a>
                                    </span>
                                </div>
