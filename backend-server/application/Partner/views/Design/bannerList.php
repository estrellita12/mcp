                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select id="ctg1" name="ctg1">
                                <option value="">=카테고리 선택=</option>
                                <?php foreach($this->categoryDepth1 as $row){ ?>
                                <?=get_frm_option($row['ctg_id'], substr(get_request("ctg"),0,3), $row['ctg_title']);?>
                                <?php } ?>
                            </select>
        ...
        <form>
            <div class="list_wrap">
                ...
                <div class="btn_wrap">
                    ...
                    <a href="#" onclick="winOpen('/Design/bannerOdrPopup?device=<?=get_request("device")?>&position=<?=get_request("position")?>','bannerSortable','1200','900','yes');" class="btn_small btn_red">순서 변경</a>
                    <?php } ?>
                </div>
                    ...
                    <table class="draggable">
                        <thead>
                            <tr>
                                ...
                                <?=get_sort_tag("bn_reg_dt","등록일시","w120")?>
