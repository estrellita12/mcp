                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="deliveryNo[]" value="<?=$row['od_delivery_no2']?>" class="w100p"></td>
                                <td>
                                    <select name="deliveryCompany[]">
                                ...
                                <td><input type="text" name="deliveryNo[]" value="<?=$row['od_delivery_no3']?>" class="w100p"></td>
