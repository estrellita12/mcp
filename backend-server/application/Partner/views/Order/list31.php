                ...
                <div class="chead01_wrap">
                    <table>
                        <colgroup>
                            ...
                            <col class="w100">   <!-- 결제방법 -->
                            <col class="w100">   <!-- 주문상태 -->
                            <?php if( $this->param['ident'] == 11 || $this->param['ident'] == 13 ){ ?>
                            <col class="w150">   <!-- 택배사 -->
                            <col class="w120">   <!-- 송장번호 -->
                            <?php } ?>
                            <?php if( $this->param['ident'] == 42 ){ ?>
                            <col class="w100">   <!-- 취소사유 -->
                            <?php } ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?=$row['od_qty']?></td>
                                <td class="tar"><?=number_format($row['od_goods_price'])?></td>
...
<td>
                            ...
                            <?php } ?>
                            <?php if( $this->param['ident'] == 42 ){ ?>
                                <td class="dot"><?=$row['od_cancel_reason']?></td>
                            <?php } ?>
