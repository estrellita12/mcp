<section class="contents" id="main_index">
    <div class="marb40">
        <div class="notice_wrap">
            <div class="board_item">
                ...
                <div class="post_title"><span onclick=winOpen("/Main/notice","noticeBoard","1200px","700px")><?=$this->board['list']['bopo_title']?><span></div>
            </div>
        </div>
    </div>
    <div class="marb40">
    ...
    <div class="marb40">
        <div class="h2">가입 현황</div>
        <div class="index_wrap">
            <div class="box_wrap box_col2">
                <div class="item_wrap box_col6">
                    <div class="item_title">오늘 가입자수</div>
                    <div class="item_data"><span class="number_data"><?=number_format($this->member['mb_cnt'])?></span>명</div>
                </div>
            </div>
        </div>
    </div>
