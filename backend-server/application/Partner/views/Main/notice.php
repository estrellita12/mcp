                    ...
                    <table class="draggable">
                        ...
                        <tbody>
                            ...
                            <tr class="list<?=$i%2?>">
                                <td><?=$row['bopo_id']?></td>
                                <td class="tal">
                                    <a href="" onclick=winOpen("/Main/postView/<?=$row['bopo_id']?>?board=<?=$_REQUEST['board']?>") >
                                        <?=$row['bopo_title']?>
                                    </a>
                                </td>
                                <td><?=$row['user_name']?></td>
                                ...
                                <td>
                                    ...
                                    <a href="" onclick=winOpen("/Main/postAnswer/<?=$row['bopo_id']?>?board=<?=$_REQUEST['board']?>","noticeAnswer") class="btn_white btn_small">답글</a>
                                    <?php } ?>
                                </td>
                            </tr>
                            ...
                            <tr class="list0">
                                <td>-</td>
                                <td class="tal">
                                    <a href="/Main/postView/<?=$row2['bopo_id']?>?board=<?=$_REQUEST['board']?>">
                                ...
                                <td>
                                    <?php if($this->replyAllow){ ?>
                                    <a href="" onclick=winOpen("/Main/postAnswer/<?=$row2['bopo_id']?>?board=<?=$_REQUEST['board']?>","noticeAnswer") class="btn_white btn_small">답글</a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php } ?>
