<div id="contents">
    ...
    <section class="cont_inner">
        ...
        <form name="fForm" action="/Design/planFormUpdate" method="POST" onsubmit="return frm_submit(document.frm);">
            ...
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="use_yn" value="y" id="use_yn" <?=get_checked($this->row['use_yn'], "y");?> ><label for="use_yn"> 노출함</label>
                        </td>
                    </tr>   
                   <tr>
