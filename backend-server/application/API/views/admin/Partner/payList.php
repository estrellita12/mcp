    ...
    <section class="cont_inner">
        ...
        <div class="layout01_wrap">
            <div class="layout_inner">
                ...
                <div class="btn_wrap">
                    <!-- <a href="#" id="frmExcel" class="btn_small btn_white" data-file="/Partner/payListExcel"><img src="<?=_ICON?>excel_download.png" width=15> 선택항목 엑셀저장</a> -->
                    <a href="/Partner/payListExcel?<?=get_qstr()?>" class="btn_small btn_white"><img src="<?=_ICON?>/excel_download.png" width=15> 검색결과 엑셀저장</a>
                </div>
                <div class="chead01_wrap">
                    <table>
                        ...
                        <tr class="list<?=$i%2?>">
                            ...
                            <td><a href="/Partner/payListDescExcel?shp=<?=$row['pt_id']?>&<?=get_qstr()?>" class="btn_small btn_white">다운로드</a></td>
                        </tr>
                        <?php  $i++; } ?>
                        </tbody>
                    </table>
