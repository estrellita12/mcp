            ...
            <div class="search_wrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="srch">
                                ...
                                <?= get_frm_option('brand', $_REQUEST['srch'], '브랜드'); ?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="scDT">
                                <?=get_frm_option('reg_time',$_REQUEST['scDT'],'등록일')?>
                                <?=get_frm_option('update_time',$_REQUEST['scDT'],'수정일')?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="sQ">
                                <?=get_frm_option('stock_qty',$_REQUEST['sQ'],'재고 수량')?>
                                <?=get_frm_option('noti_qty',$_REQUEST['sQ'],'통보 수량')?>
                            </select>
                            <input type="text" size=5> 개 이상 ~ <input type="text" size=5> 개 이하
                        </td>
                    </tr>
                    <tr>
        ...
        <form>
            <div class="layout01_wrap">
                <div class="layout_inner">
                    ...
                    <div class="btn_wrap">
                        <a href="#" id="fexcel" class="btn_small btn_white" data-file="/Goods/listExcel"><img src="<?=_ICON?>excel_download.png" width=15> 선택항목 엑셀저장</a>
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><a href="<?=get_sort_url("stock_qty",$_REQUEST['colBy'])?>">재고</a></th>
                                ...
                                <tr>
                                    ...
                                    <th scope="col"><a href="<?=get_sort_url("sl_id",$_REQUEST['colBy'])?>">가맹점</a></th>
                                    <th scope="col"><a href="<?=get_sort_url("ca_id",$_REQUEST['colBy'])?>">카테고리</a></th>
                                    ...
                                    <th scope="col"><a href="<?=get_sort_url("readcount",$_REQUEST['colBy'])?>">조회수</a></th>
                            ...
                            <tr class="list<?= $i%2 ?>">
                                ...
                                <td class="tac"><?=number_format($row['stock_qty'])?></td>
                                ...
                                <td rowspan="2" class="tac"><?=number_format($row['readcount'])?></td>
                                <td rowspan="2" class="tac"><?=number_format($row['sum_qty'])?></td>
                                <td rowspan="2" class="tac"><a href="/Goods/update/<?=$row['idx']?>" class="btn_white btn_small">수정</a></td>
                            </tr>
                            <tr class="list<?=$i%2?>">
                                <td class="tac"><?=$row['gcode']?></td>
                                <td class="tal seller"><?=$this->pt_li[$row['sl_id']]?></td>
