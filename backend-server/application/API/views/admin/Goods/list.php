...
$(function() {
    ...
    $("#ctg5").ctg_select_box("#ctg",5,"","=카테고리선택=");
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="qty">
                                <?=get_frm_option('stock_qty',$_REQUEST['qty'],'재고 수량')?>
                                <?=get_frm_option('noti_qty',$_REQUEST['qty'],'통보 수량')?>
                            </select>
                            <input type="text" name="bqty" value="<?=$_REQUEST['bqty']?>" size=5> 개 이상 ~ <input type="text" name="eqty" value="<?=$_REQUEST['eqty']?>" size=5> 개 이하
                        </td>
                    </tr>
                    <tr>
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><a href="<?=get_sort_url("update_time",$_REQUEST['colBy'])?>">등록일</a></th>
                            ...
                            <tr class="list<?= $i%2 ?>">
                                ...
                                <td rowspan="2" class="tac"><?=$this->goods->getImg($row['simg1'],"35px")?></td>
                            ...
                            <tr class="list<?=$i%2?>">
                                ...
                                <td class="tal ctg_nav"><?=$this->category->getCtgNav($row['ctg'])?></td>
