    ...
    <section class="cont_inner">
        ...
        <div class="layout01_wrap">
            <div class="layout_inner">
                <div class="rect_wrap">
                    <span class="cnt_wrap">
                        검색된 가맹점 :<b class="cnt"><?= $this->totCnt ?></b>개
                    </span>
                    <span>
                ...
                <div class="chead01_wrap">
                    <table>
                        ...
                        <tr class="list<?=$i%2?>">
                            ...
                            <td><?=$this->seller->getName($row['seller_id'])?></td>
                            <td><a href="#" onclick="win_open('/Partner/popupForm/<?=$row['seller_id']?>','sellerForm','1200','600','yes');" ><?=$row['seller_id']?></a></td>
                            ...
                            <td><a href="/Partner/turnoverDescExcel?scPT=<?=$row['seller_id']?>&<?=get_qstr()?>" class="btn_small btn_white">다운로드</a></td>
                        </tr>
                        <?php  $i++; } ?>
                        </tbody>
                    </table>
