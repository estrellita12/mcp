        ...
        <form>
            <div class="layout01_wrap">
                <div class="layout_inner">
                    ...
                    <div class="btn_wrap">
                        <a href="#" id="fexcel" class="btn_small btn_white" data-file="/Seller/listExcel"><img src="<?=_ICON?>excel_download.png" width=15> 선택항목 엑셀저장</a>
                        <a href="/Seller/listExcel?<?=get_qstr()?>" class="btn_small btn_white"><img src="<?=_ICON?>excel_download.png" width=15> 검색결과 엑셀저장</a>
                        <a href="/Seller/form" class="fr btn_small btn_red"><i class="ionicons ion-android-add"></i> 가맹점추가</a>
                    </div>
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" rowspan="2"><a href="<?=get_sort_url("reg_date",$_REQUEST['colBy'])?>">가입일</a></th>
                                    <th scope="col" rowspan="2"><a href="<?=get_sort_url("app_date",$_REQUEST['colBy'])?>">승인일</a></th>
                            ...
                            <tbody>
                            <?php $i=0; foreach($this->seller->getList('*') as $row) { ?>
                            <tr class="list<?=$i%2?>">
                                <td>
                                ...
                                <td><?=$row['name']?></td>
                                <td><a href="#" onclick="winOpen('/Seller/popup/<?=$row['id']?>','sellerForm','1200','600','yes');" ><?=$row['id']?></a></td>
                                ...
                                <td><a href="/Seller/expire/<?=$row['id']?>" class="btn_white btn_small">만료</a></td>
                            </tr>
                            <?php  $i++; } ?>
                            </tbody>
                        </table>
