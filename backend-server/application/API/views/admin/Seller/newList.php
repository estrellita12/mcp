        ...
        <form>
            <div class="layout01_wrap">
                <div class="layout_inner">
                    ...
                    <div class="btn_wrap">
                        <a href="#" id="fexcel" class="btn_small btn_white" data-table="/Seller/listExcel"><img src="<?=_ICON?>excel_download.png" width=15> 선택항목 엑셀저장</a>
                    ...
                    <div class="chead01_wrap">
                        <table>
                            ...
                            <tr class="list<?=$i%2?>">
                                ...
                                <td><?=$row['name']?></td>
                                <td><a href="#" onclick="winOpen('/Seller/popupForm/<?=$row['id']?>','partnerForm','1200','600','yes');" ><?=$row['id']?></a></td>
                                <td><?=$row['reg_dt']?></td>
                                <td><?=$row['manager_name']?></td>
                                <td><?=$row['manager_cellphone']?></td>
                                <td><?=$row['manager_email']?></td>
                                <td><a href="/Seller/approval/<?=$row['id']?>" class="btn_small btn_white">승인</a></td>
                            </tr>
                            <?php $i++; } ?>
                            </tbody>
                        </table>
