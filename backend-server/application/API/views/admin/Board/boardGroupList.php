    ...
    <section class="cont_inner">
            ...
            <div class="search_wrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="scCol">
                                <?= get_frm_option('id', $_REQUEST['scCol'], '그룹아이디'); ?>
        ...
        <div class="layout01_wrap">
            <div class="layout_inner">
                <div class="rect_wrap">
                    <span class="cnt_wrap">
                        검색된 그룹 :<b class="cnt"><?= number_format($this->totCnt) ?></b>개
                    </span>
                    <span>
                ...
                <div class="btn_wrap">
                    <a href="/Board/boardGroupForm?mode=i" class="fr btn_small btn_red"><i class="ionicons ion-android-add"></i> 그룹추가</a>
                </div>
                    ...
                    <table>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><a href="<?=get_sort_url("id",$_REQUEST['colBy'])?>">그룹아이디</a></th>
                        ...
                        <tr class="list<?=$i%2?>">
                            ...
                            <td><a href="/Board/boardGroupForm/<?=$row['idx']?>?mode=u" class="btn_white btn_small">수정</a></td>
                        </tr>
                        <?php  $i++; } ?>
                        </tbody>
                    </table>
