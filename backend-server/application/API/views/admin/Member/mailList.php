        ...
        <form>
            <div class="layout01_wrap">
                <div class="layout_inner">
                    ...
                    <div class="btn_wrap">
                        <a href="/Member/mailForm" class="fr btn_small btn_red">메일 추가</a>
                    </div>
                    <div class="chead01_wrap">
                        <table>
                            ...
                            <tbody>
                            <?php $i=0; foreach( $this->mail->getList($this->col) as $row) {?>
                            <tr class="list<?=$i%2?>">
                                <td>
                                ...
                                <td><?=$row['reg_dt']?></td>
                                <td><?=$row['send_dt']?></td>
                                <td><a href="/Member/mailForm/<?=$row['idx']?>" class="btn btn_white btn_small">수정</a></td>
                            </tr>
                            <?php $i++; } ?>
                            </tbody>
                        </table>
