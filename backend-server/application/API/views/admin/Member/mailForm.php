<div id="contents">
    ...
    <section class="cont_inner">
        ...
        <form name="fForm" action="/Member/mailFormUpdate<?=get_data($this->param['ident'],'/')?>" onsubmit="return fForm_submit(this);"  method="POST">
            <input type="hidden" name="idx" value="<?=get_data($this->param['ident'])?>">
            <div class="rhead01_wrap">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="title" class="required" value="<?=get_data($this->row['title'])?>" placeholder="제목없음" required>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if( isset($this->row['send_dt']) ) $send_dt = explode(" ",$this->row['send_dt'])  ?>
